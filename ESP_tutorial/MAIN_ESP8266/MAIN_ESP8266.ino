...
//////////////////////////////////////////////
const char SSID_ESP[] = "Azimi";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "bismillah";             //Add the password of that WIFI connection
const char* host = "103.253.212.155";  //Add the host without "www" Example: electronoobs.com
...
String location_url = "http://iot.spairum.com/TX.php?id=";            //location of your PHP file on the server. In this case the TX.php is directly on the first folder of the server
